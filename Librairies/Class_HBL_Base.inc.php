...
class SGBDR {
	public function sauvegardeBase( $Version_Loxense ) {
		...
		$Nom_Fichier = DIR_SAUVEGARDES . DIRECTORY_SEPARATOR . 'MySecDash-' . $_Version . '-Base-' . date("Y_m_d-H_i_s") . '.sql';
	...
	public function restaureBase( $Version, $Date ) {
		...
		$Nom_Fichier = DIR_SAUVEGARDES . DIRECTORY_SEPARATOR . 'MySecDash-' . $Version . '-Base-' . $Date . '.sql';
