...
*/
	...
	$L_PartiePrenante_Confirm_Suppression = 'Do you really want to remove ' . $L_PartiePrenante . ' "<span class="purple">%s</span>"?';
	$L_PartiePrenante_Confirm_Suppression_Associe = 'Warning, the ' . $L_PartiePrenante . ' "<span class="purple">%s</span>" is associated with:';
