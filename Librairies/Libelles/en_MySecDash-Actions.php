...
*/
	...
	$L_Action_Confirm_Suppression = '<div class="row col-lg-12">Do you really want to delete this ' . $L_Action . ' ?</div>' .
		'<div class="row">' .
		'<span class="col-lg-3">Label :</span><span class="fg_couleur_1 col-lg-9">%act_libelle</span>' .
		'<span class="col-lg-3">Actor :</span><span class="fg_couleur_1 col-lg-9">%acteur</span>' .
		'<span class="col-lg-3">Priority :</span><span class="fg_couleur_1 col-lg-9">%act_priorite</span>' .
		'<span class="col-lg-3">Begin date :</span><span class="fg_couleur_1 col-lg-9">%date_debut</span>' .
		'<span class="col-lg-3">End date :</span><span class="fg_couleur_1 col-lg-9">%date_fin</span>' .
		'<span class="col-lg-3">Status :</span><span class="fg_couleur_1 col-lg-9">%act_statut</span>' .
		'</div>';
	$L_Action_Confirm_Suppression_Associe = 'Warning, this ' . $L_Action . ' "<span class="fg_couleur_1">%s</span>" is associated with:';
