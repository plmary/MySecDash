...
*/
	...
	$L_Etiquette_Confirm_Suppression = 'Do you really want to delete this ' . $L_Etiquette . ' "<span class="fg_couleur_1">%s</span>"?';
	$L_Etiquette_Confirm_Suppression_Associe = 'Warning, this ' . $L_Etiquette . ' "<span class="fg_couleur_1">%s</span>" is associated with:';
