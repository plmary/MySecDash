...
*/
	...
	$L_Gestionnaire_Confirm_Suppression = 'Do you really want to delete this ' . $L_Gestionnaire . ' "<span class="fg_couleur_1">%s</span>"?';
	$L_Gestionnaire_Confirm_Suppression_Associe = 'Warning, this ' . $L_Gestionnaire . ' "<span class="fg_couleur_1">%s</span>" is associated with:';
