...
*/
	...
	$L_Gestionnaire_Confirm_Suppression = 'Voulez-vous vraiment supprimer ce ' . $L_Gestionnaire . ' "<span class="purple">%s</span>" ?';
	$L_Gestionnaire_Confirm_Suppression_Associe = 'Attention, ce ' . $L_Gestionnaire . ' "<span class="purple">%s</span>" est associée avec :';
