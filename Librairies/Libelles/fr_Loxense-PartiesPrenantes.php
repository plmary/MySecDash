...
*/
	...
	$L_PartiePrenante_Confirm_Suppression = 'Voulez-vous vraiment supprimer la ' . $L_PartiePrenante . ' "<span class="purple">%s</span>" ?';
	$L_PartiePrenante_Confirm_Suppression_Associe = 'Attention, la ' . $L_PartiePrenante . ' "<span class="purple">%s</span>" est associée avec :';
