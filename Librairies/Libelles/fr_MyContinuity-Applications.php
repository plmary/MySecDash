...
*/
	...
	$L_Hebergement = 'Hébergement';
	$L_Niveau_Service = 'Niveau de service';
	...
	$L_Confirmer_Suppression_Application = 'Voulez-vous vraiment supprimer l\'application "<span class="fg_couleur_1 fw-bold">%s</span>" ?';
	$L_Confirmer_Suppression_Application_Associee = 'Attention, l\'application "<span class="fg_couleur_1 fw-bold">%s</span>" est associée avec :';
?>