...
*/
	...
	$L_Action_Confirm_Suppression = '<div class="row col-lg-12">Voulez-vous vraiment supprimer cette ' . $L_Action . ' ?</div>' .
		'<div class="row">' .
		'<span class="col-lg-3">Libellé :</span><span class="fg_couleur_1 col-lg-9">%act_libelle</span>' .
		'<span class="col-lg-3">Acteur :</span><span class="fg_couleur_1 col-lg-9">%acteur</span>' .
		'<span class="col-lg-3">Priorité :</span><span class="fg_couleur_1 col-lg-9">%act_priorite</span>' .
		'<span class="col-lg-3">Date début :</span><span class="fg_couleur_1 col-lg-9">%date_debut</span>' .
		'<span class="col-lg-3">Date fin :</span><span class="fg_couleur_1 col-lg-9">%date_fin</span>' .
		'<span class="col-lg-3">Statut :</span><span class="fg_couleur_1 col-lg-9">%act_statut</span>' .
		'</div>';
	$L_Action_Confirm_Suppression_Associe = 'Attention, cette ' . $L_Action . ' "<span class="fg_couleur_1">%s</span>" est associée avec :';
	...
	$L_Confirmer_Supprimer_Preuve = '<div class="col-lg-12"><span>%prv_libelle</span> (<span class="fg_couleur_1">%prv_fichier</span>)</div>' .
