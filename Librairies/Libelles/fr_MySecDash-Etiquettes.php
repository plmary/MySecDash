...
*/
	...
	$L_Etiquette_Confirm_Suppression = 'Voulez-vous vraiment supprimer cette ' . $L_Etiquette . ' "<span class="fg_couleur_1">%s</span>" ?';
	$L_Etiquette_Confirm_Suppression_Associe = 'Attention, cette ' . $L_Etiquette . ' "<span class="fg_couleur_1">%s</span>" est associée avec :';
