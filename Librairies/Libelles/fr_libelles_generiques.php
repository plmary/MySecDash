...
*/
	...
	$L_Imprimer = 'Imprimer';
	$L_Changer_Mot_Passe = "Changer de mot de passe";
	$L_Retour = 'Retour';
	$L_Envoyer = 'Envoyer';
	...
	$L_Confirmer_Supprimer_Fichier = '<div class="col-lg-12"><span><strong>%libelle_fichier</strong></span> (<span class="purple">%nom_fichier</span>)</div>' .
